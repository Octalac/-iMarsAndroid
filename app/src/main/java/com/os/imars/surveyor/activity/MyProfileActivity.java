...
public class MyProfileActivity extends BaseActivity {
    ...
    private TextView txtEmailAddress, txtCompanyWebsite, txtUsername, txtAddress,
            ...
            txtSSSNumber, txtNumberOfSurvey, txtExperience, txtAboutMe, txtRating, txtCompanyCountry, txtPhoneNumber,
            txtAverageResponseTime, txtJobAcceptance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_surveyor_my_profile);
        initView();
        callApi();
    }
    ...
    private void setData(UserDataItem data) {
        ...
        switch (data.getType()) {
            case "2":
                txtDesignation.setText("DP of a Surveyor Company");
                break;
            case "3":
                txtDesignation.setText("Surveyor of a Surveyor Company");
                break;
            case "4":
                txtDesignation.setText("Individual Surveyor");
                llSSN.setVisibility(View.VISIBLE);
                viewSSN.setVisibility(View.VISIBLE);
                break;
        }
    }
